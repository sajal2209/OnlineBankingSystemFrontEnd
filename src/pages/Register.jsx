...
const Register = () => {
  ...
  const validate = () => {
    ...
    if (username.length > 20)
      tempErrors.username = "Username too long (max 20).";
    ...
    if (password.length > 15)
      tempErrors.password = "Password too long (max 15).";
    ...
    if (validate()) {
      ...
      dispatch(
        ...
        .catch((error) => {
          ...
          if (
            typeof error === "string" &&
            error.includes("size must be between")
          ) {
            setSnackbarMessage(
              "Registration failed: Please check inputs (Password min 6, Username min 3)."
            );
        ...
        >
          ...
          >
            ...
            <Typography variant="body1">
              Create your secure banking account today and experience next-gen
              financial services.
            </Typography>
          </Box>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12}>
                    <TextField
                      ...
                      helperText={
                        errors.phoneNumber || "10-digit mobile number"
                      }
                      inputProps={{
                        maxLength: 10,
                        inputMode: "numeric",
                  ...
                  <Grid item xs={12}>
                    <TextField
                      ...
                      helperText={errors.password || "6–15 characters"}
                      inputProps={{
                        maxLength: 15,
                      }}
                      InputProps={{
