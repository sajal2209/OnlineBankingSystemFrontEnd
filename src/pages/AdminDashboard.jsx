...
const AdminDashboard = () => {
  ...
  const [transactions, setTransactions] = useState([]); // State for pending transactions
  ...
  const loadPendingTransactions = () => {
    AdminService.getPendingTransactions().then(
      (response) => {
  ...
  const handleApprove = (id) => {
    AdminService.approveTransaction(id).then(
      (response) => {
        setMessage(response.data.message);
        setSuccessful(true);
        loadPendingTransactions();
  ...
  const handleReject = (id) => {
    AdminService.rejectTransaction(id).then(
      (response) => {
        setMessage(response.data.message);
        setSuccessful(true);
        loadPendingTransactions();
          ...
          <Dialog open={open} onClose={handleClose}>
            ...
            <DialogContent>
              ...
              <TextField
                ...
                helperText={fieldErrors.password || "6–15 characters"}
              ...
              <TextField
                ...
                helperText={fieldErrors.phoneNumber || "10-digit mobile number"}
                inputProps={{
                  maxLength: 10,
                  inputMode: "numeric",
                }}
            ...
            <DialogActions>
              ...
              <Button onClick={handleCreateBanker} variant="contained">
                Create
              </Button>
            </DialogActions>
          </Dialog>
      ...
      {tabValue === 1 && (
        <Box>
          ...
          <TableContainer component={Paper}>
            <Table
              sx={{ minWidth: 650 }}
              aria-label="pending transactions table"
            >
              <TableHead>
                <TableRow>
                  <TableCell>ID</TableCell>
